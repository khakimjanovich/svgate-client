...
final class EndpointsRpcExceptionTest extends TestCase
{
    /** @dataProvider rpcErrorCalls
     * @throws JsonException
     */
    public function test_json_rpc_error_mapped(string $label, callable $call): void
    {
    ...
    public static function rpcErrorCalls(): array
    {
